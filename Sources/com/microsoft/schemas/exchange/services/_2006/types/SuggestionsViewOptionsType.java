...
public class SuggestionsViewOptionsType {
    ...
    @XmlElement(name = "CurrentMeetingTime", type = String.class)
    @XmlJavaTypeAdapter(Adapter1 .class)
    @XmlSchemaType(name = "dateTime")
    protected Calendar currentMeetingTime;
     ...
     *     
     */
    public Calendar getCurrentMeetingTime() {
     ...
     *     
     */
    public void setCurrentMeetingTime(Calendar value) {
