...
public class AttendeeType {
    ...
    @XmlElement(name = "LastResponseTime", type = String.class)
    @XmlJavaTypeAdapter(Adapter1 .class)
    @XmlSchemaType(name = "dateTime")
    protected Calendar lastResponseTime;
     ...
     *     
     */
    public Calendar getLastResponseTime() {
     ...
     *     
     */
    public void setLastResponseTime(Calendar value) {
