...
public class ConversationActionType {
    ...
    @XmlElement(name = "ConversationLastSyncTime", type = String.class)
    @XmlJavaTypeAdapter(Adapter1 .class)
    @XmlSchemaType(name = "dateTime")
    protected Calendar conversationLastSyncTime;
     ...
     *     
     */
    public Calendar getConversationLastSyncTime() {
     ...
     *     
     */
    public void setConversationLastSyncTime(Calendar value) {
