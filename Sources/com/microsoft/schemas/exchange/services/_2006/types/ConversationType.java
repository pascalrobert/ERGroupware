...
public class ConversationType {
    ...
    @XmlElement(name = "LastDeliveryTime", type = String.class)
    @XmlJavaTypeAdapter(Adapter1 .class)
    @XmlSchemaType(name = "dateTime")
    protected Calendar lastDeliveryTime;
    @XmlElement(name = "GlobalLastDeliveryTime", type = String.class)
    @XmlJavaTypeAdapter(Adapter1 .class)
    @XmlSchemaType(name = "dateTime")
    protected Calendar globalLastDeliveryTime;
     ...
     *     
     */
    public Calendar getLastDeliveryTime() {
     ...
     *     
     */
    public void setLastDeliveryTime(Calendar value) {
     ...
     *     
     */
    public Calendar getGlobalLastDeliveryTime() {
     ...
     *     
     */
    public void setGlobalLastDeliveryTime(Calendar value) {
