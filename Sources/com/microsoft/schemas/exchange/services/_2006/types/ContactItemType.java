    ...
    extends ItemType
{
    ...
    @XmlElement(name = "WeddingAnniversary", type = String.class)
    @XmlJavaTypeAdapter(Adapter1 .class)
    @XmlSchemaType(name = "dateTime")
    protected Calendar weddingAnniversary;
     ...
     *     
     */
    public Calendar getWeddingAnniversary() {
     ...
     *     
     */
    public void setWeddingAnniversary(Calendar value) {
