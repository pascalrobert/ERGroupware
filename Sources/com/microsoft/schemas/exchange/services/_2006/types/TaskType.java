    ...
    extends ItemType
{
    ...
    @XmlElement(name = "AssignedTime", type = String.class)
    @XmlJavaTypeAdapter(Adapter1 .class)
    @XmlSchemaType(name = "dateTime")
    protected Calendar assignedTime;
    ...
    @XmlJavaTypeAdapter(Adapter1 .class)
    @XmlSchemaType(name = "dateTime")
    protected Calendar completeDate;
     ...
     *     
     */
    public void setAssignedTime(Calendar value) {
     ...
     *     
     */
    public void setCompleteDate(Calendar value) {
