    ...
    extends MeetingMessageType
{
    ...
    @XmlElement(name = "OriginalStart", type = String.class)
    @XmlJavaTypeAdapter(Adapter1 .class)
    @XmlSchemaType(name = "dateTime")
    ...
    @XmlElement(name = "AppointmentReplyTime", type = String.class)
    @XmlJavaTypeAdapter(Adapter1 .class)
    @XmlSchemaType(name = "dateTime")
    protected Calendar appointmentReplyTime;
     ...
     *     
     */
    public Calendar getAppointmentReplyTime() {
     ...
     *     
     */
    public void setAppointmentReplyTime(Calendar value) {
